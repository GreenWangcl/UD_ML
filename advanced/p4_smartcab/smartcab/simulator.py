        ...
        if self.log_metrics:
            ...
            if a.learning:
                if self.optimized: # Whether the user is optimizing the parameters and decay functions
                    self.log_filename = os.path.join("logs", "sim_improved-learning_{}_with_decay_rate_{}.csv".format(a.decay_method, a.decay_rate))
                    self.table_filename = os.path.join("logs", "sim_improved-learning_{}_with_decay_rate_{}.txt".format(a.decay_method, a.decay_rate))
                else: 
